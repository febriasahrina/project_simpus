...
<title>Cetak Nota Pinjam Per Siswa</title>
...
<table width="600" border="0" cellspacing="1" cellpadding="3">
  <?php 
  if ($kode!="Semua") {
    $mysqli = "SELECT nim,nm_mahasiswa FROM vlapsiswa $filterSQL";
  ...
  <tr>
    ...
    <td width="10">:</td>
    <td width="448">Laporan Peminjaman Buku Per Siswa</td>
  </tr>
  <tr>
    <td width="120"><strong>NIM </strong></td>
    <td width="10">:</td>
    <td width="448"><?php echo $myData['nim']; ?></td>
  </tr>
  <tr>
    <td width="120"><strong>Nama </strong></td>
    <td width="10">:</td>
    <td width="448"><?php echo $myData['nm_mahasiswa']; ?></td>
  </tr>
  <?php } ?>
  <?php if ($kode=="Semua"){ ?>
  <tr>
...
<table width="1000" border="0" cellspacing="1" cellpadding="3">
  <tr>
    ...
    <td width="150" bgcolor="#CCCCCC"><strong>Tgl. Kembali </strong></td>
    <td width="150" bgcolor="#CCCCCC"><strong>Mahasiswa </strong></td>
    <td width="150" bgcolor="#CCCCCC"><strong>Buku </strong></td>
    <td width="150" bgcolor="#CCCCCC"><strong>Admin </strong></td>
    ...
    $notaSql = "SELECT * FROM vlapsiswa $filterSQL";
  ...
  <tr>
    ...
    <td> <?php echo $notaData['tgl_kembali']; ?> </td>
    <td> <?php echo $notaData['nm_mahasiswa']; ?> </td>
    <td> <?php echo $notaData['judul']; ?> </td>
    <td> <?php echo $notaData['username']; ?> </td>
