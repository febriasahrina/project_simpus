   ...
   $tampil = mysqli_query($koneksidb,$query);
    ...
    while ($tyo = mysqli_fetch_array($tampil)):
        ...
        echo "           
            ...
            <a class=\"btn btn-danger\" href=\"$aksi?module=kategori&act=hapus&kd_kategori=$tyo[kd_kategori]\" onclick=\"return confirm('Apakah Anda yakin menghapus data ini? Maka data buku dan pengadaan juga akan terhapus')\">
