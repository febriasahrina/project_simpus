...
<div class=" row">
    <div class="col-md-3 col-sm-3 col-xs-6">
        <?php $siswa = mysqli_fetch_array(mysqli_query($koneksidb,"SELECT count(*) as total FROM mahasiswa")); ?>
    ...
    <div class="col-md-3 col-sm-3 col-xs-6">
        ...
        <a data-toggle="tooltip" title="<?php echo $buku['total']; ?>" class="well top-block" href="?module=buku">
            ...
            <div class="box-content row">
                <div class="col-lg-12 col-md-12">
                    <h1>SIMPUS (Sistem Informasi Manajemen Perpustakaan)
                        <small><br>Selamat Datang di SIMPUS</small>
                    </h1>
