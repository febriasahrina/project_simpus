...
echo "<table class=\"table table-striped table-bordered bootstrap-datatable datatable responsive\">
   ...
   $query  =mysqli_query($koneksidb,"SELECT mahasiswa.nm_mahasiswa,peminjaman.no_pinjam,peminjaman.status,peminjaman.tgl_pinjam,peminjaman.tgl_kembali, peminjaman_detil.no_pinjam, peminjaman_detil.kd_buku, buku.kd_buku, buku.judul FROM peminjaman, mahasiswa, peminjaman_detil, buku WHERE peminjaman.nisn=mahasiswa.nim AND peminjaman_detil.no_pinjam=peminjaman.no_pinjam AND peminjaman_detil.kd_buku = buku.kd_buku AND  status='Kembali' ORDER BY peminjaman.no_pinjam");
